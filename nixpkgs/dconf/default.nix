...
in
{
  dconf.settings = {
    ...
    "org/blueman/plugins/recentconns" = {
      recent-connections = "[{'adapter': '80:32:53:F6:C6:7D', 'address': '20:18:06:00:A2:0D', 'alias': 'JLab Neon BT', 'icon': 'audio-card', 'name': 'Audio and input profiles', 'uuid': '00000000-0000-0000-0000-000000000000', 'time': '1626030199.5652943'}]";
    };
